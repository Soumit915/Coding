...
public class SubsetSums {
    ...
    static void computeSubsetSums(ArrayList<Long> arlist, long[] arr, int start, int n){
        int lim = 1<<n;
        for(int i=0;i<lim;i++){
    ...
    public static void main(String[] args) throws IOException {
        ...
        ArrayList<Long> arlist1 = new ArrayList<>();
        ArrayList<Long> arlist2 = new ArrayList<>();
        computeSubsetSums(arlist1, arr, 0, n/2);
        computeSubsetSums(arlist2, arr, n/2, n-n/2);

        Collections.sort(arlist1);
        Collections.sort(arlist2);

        long count = 0;
        for (Long aLong : arlist1) {
            int l = binarySearch_greater(arlist2, a - aLong, 0, arlist2.size() - 1);
            int r = binarySearch_lower(arlist2, b - aLong, 0, arlist2.size() - 1);
            if (l <= r) {
                count += (r - l + 1);
            }
        }
