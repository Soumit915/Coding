...
public class TowerBreakersAgain {
    ...
    static ArrayList<Boolean> isPrime = new ArrayList<>();
    static ArrayList<Integer> spf = new ArrayList<>();
    ...
    static int getNumberOfOddPrimeFactors(int n){
        int count = 0;
        while(n>1){
            int factor = spf.get(n);
            n /= factor;
            if(factor%2==1){
                count++;
            }
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (t-->0){
            ...
            int xor = 0;
            for(int i=0;i<n;i++){
                int k = getNumberOfOddPrimeFactors(arr[i]);
                k = (arr[i]%2==0)?k+1:k;
                xor ^= k;
            }
