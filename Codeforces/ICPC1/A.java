...
public class A {
    ...
    static class Pair implements Comparable<Pair>{
        ...
        public int compareTo(Pair p){
            int c = Integer.compare(this.ai, p.ai);
            if(c == 0)
                return Integer.compare(this.bi, p.bi);
            else return c;
        }
    }
        ...
        while (tc-->0){
            ...
            if(isValid(pairs)){
                ...
                for(int i=0;i<n;i++){
                    ...
                    if(pairs[i] == unsorted[i])
                        continue;

                    int index = 0;
                    for(int j=i+1;j<n;j++){
                        if(unsorted[j] == pairs[i]){
                            index = j;
                            break;
                        }
                    }
