package Codeforces.Round750Div2;

import java.io.*;
import java.util.*;

public class F1_BruteForce {
    ...
    static boolean isIncreasing(ArrayList<Integer> arlist){
        for(int i=1;i<arlist.size();i++){
            if(arlist.get(i)<=arlist.get(i-1)){
                return false;
            }
        }
        return true;
