...
public class AssignmentAndMinimum {
    ...
    static void update(Node[] segTree, int si, int start, int end, int v, int l, int r){
        ...
        if(segTree[si].hasLazyVal){
            segTree[2*si + 1].val = segTree[si].val;
            segTree[2*si + 1].hasLazyVal = true;

            segTree[2*si + 2].val = segTree[si].val;
        ...
        segTree[si].val = Math.min(segTree[2*si + 1].val, segTree[2*si + 2].val);
    }
    ...
    static int query(Node[] segTree, int si, int start, int end, int l, int r){
        ...
        return Math.min(query(segTree, 2*si + 1, start, end, l, mid),
