        ...
        while (m-->0){
            ...
            switch (type){
                case 1: int l = sc.nextInt();
                        int r = sc.nextInt();
                        long v = sc.nextLong();
                        update(segTree, 0, l, v, 0, n-1);
                        if(r!=n)
                            update(segTree, 0, r, v*-1, 0, n-1);
                    break;

                case 2: int ind = sc.nextInt();
                        sb.append(query(segTree, 0, 0, n-1, 0, ind)).append("\n");
                    break;
            }
        }
