...
public class CheatingDetection {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for(int testi = 1;testi<=t;testi++){
            ...
            for(int i=0;i<100;i++){
                int thispoint = getPoint(database[i]);
                System.out.println(i+" "+thispoint);
                int totpoint = 0;
                for(int j=0;j<100;j++){
                    if(i==j)
                        continue;
                    int curPoint = getPoint(database[j]);
                    totpoint += curPoint;
                }

                double avgPoint = totpoint/99.0;
                thispoint -= 5000;
                diff[i] = Math.abs(thispoint*2 - avgPoint);
            }
