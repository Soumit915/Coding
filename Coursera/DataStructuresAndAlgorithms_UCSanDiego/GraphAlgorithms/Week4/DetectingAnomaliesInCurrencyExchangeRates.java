...
public class DetectingAnomaliesInCurrencyExchangeRates {
    ...
    static class Graph{
        ...
        Stack<Vertex> topostk = new Stack<>();
        Graph(int n, int m){
        ...
        public void dfsTopo(Vertex source){
        ...
        public boolean bellmanFord(Vertex source){
            source.distance = 0;
    ...
    public static void main(String[] args) throws IOException {
        ...
        gr.findTopoOrdering();
        if(gr.bellmanFord(gr.topostk.peek()))
