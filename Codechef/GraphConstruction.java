        ...
        while (t-->0)
        {
            ...
            else
            {
                ...
                if(factors.size()==1)
                {
                    ...
                    {
                        int strip = n-k-1;
                        sb.append(k+strip).append("\n");
                        for(int i=1;i<strip;i++)
                        {
                            sb.append(i).append(" ").append(i+1).append("\n");
                        }
                        sb.append(strip+1).append(" ").append(1).append("\n");
                        for(int i=1;i<=k;i++)
                        {
                            sb.append(i+strip+1).append(" ").append(strip+1).append("\n");
                        }
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    for (Integer factor : factors) {
                        int div = k / factor;
                        if (flag = (n > div + factor + 1)) {
                            System.out.println(div+" "+factor);
                            int strip = n - (div + factor) - 1;
                            sb.append(factor + strip + div).append("\n");
                            System.out.println("test: "+(factor + strip + div));
                            int start = factor + div + 1;
                            for (int i1 = start; i1 < n; i1++)
                                sb.append(i1).append(" ").append(i1 + 1).append("\n");
                            for (int i1 = 1; i1 <= div; i1++)
                                sb.append(i1).append(" ").append(start).append("\n");
                            for (int i1 = div + 1; i1 <= div+factor; i1++) {
                                sb.append(i1).append(" ").append(n).append("\n");
                            }
                        }
                    }
