...
public class HiringWorkers {
    ...
    public static long brecurfun(ArrayList<Integer> arlist, int n, int m)
    {
        if(n==m)
        {
            long sum = 0;
        ...
        for(int i=n-1;i>0;i--)
        {
            ...
            {
                if(j!=i)
                    arlist1.add(arlist.get(j));
            }
            arlist1.add(arlist.get(0)*arlist.get(i));
            Collections.sort(arlist1);

            sum = brecurfun(arlist1, arlist1.size(), m);
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (t-->0)
        {
            ...
            for(int i: hash.keySet())
                pfactors.add((int) Math.pow(i, hash.get(i)));
            ...
            else
            {
                ...
                long sum = brecurfun(pfactors, pfactors.size(), k);
                sb.append(sum).append("\n");
            }
        }
